...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   cylinder_equations.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: itaharbo <itaharbo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/16 17:19:04 by itaharbo          #+#    #+#             */
/*   Updated: 2025/08/28 21:46:08 by itaharbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	cap_normal_vector(t_ray *ray, t_cylinder *cylinder, t_vector cap)
{
	...
	if (fabs(vector_dot_product(ray->direction, axis)) > EPSILON)
		normal = scalars_mult_by_vectors(-1.0f, axis);
	else
		normal = axis;
	return (normal);
}
