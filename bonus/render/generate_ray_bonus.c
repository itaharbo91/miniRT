...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   generate_ray_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: itaharbo <itaharbo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/08 17:13:11 by itaharbo          #+#    #+#             */
/*   Updated: 2025/08/22 17:27:52 by itaharbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	is_in_shadow_for_light(t_minirt *mini, t_intersection *intersection,
		t_light *light)
{
	t_vector		light_pos;
	t_vector		lvec;
	...
	light_pos = point_to_vector(light->points);
	...
	cone_intersections(mini, &mini->shadow_ray);
