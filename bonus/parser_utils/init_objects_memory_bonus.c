...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_objects_memory_bonus.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: itaharbo <itaharbo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/04 16:45:37 by itaharbo          #+#    #+#             */
/*   Updated: 2025/08/22 17:25:56 by itaharbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mini->scene.lights = ft_calloc(sizeof(t_light),
			mini->scene.light_count);
	if (!mini->scene.lights)
		fatal_perror("init_object_memory: malloc lights", mini);
	...
	mini->scene.cones = ft_calloc(sizeof(t_cone),
			mini->scene.cone_count);
	if (!mini->scene.cones)
		fatal_perror("init_object_memory: malloc cones", mini);
	mini->scene.light_count = 0;
	mini->scene.sphere_count = 0;
	mini->scene.plane_count = 0;
	mini->scene.cylinder_count = 0;
	mini->scene.cone_count = 0;
}
