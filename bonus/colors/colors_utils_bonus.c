...
/*   Updated: 2025/08/18 21:25:50 by itaharbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	light_dir_helper(t_light *light, t_intersection *intersection)
{
	t_vector	light_dir;

	light_dir = vector_subtraction(
			point_to_vector(light->points), intersection->point);
	return (light_dir);
}
